...
API_ID = int(environ.get('API_ID', '28511116'))
API_HASH = environ.get('API_HASH', '5acd24be93590c566c6a496a3094606e and')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1936313106').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001816493570).split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb://wasimakram@ac-idndlum-shard-00-00.2kh2yzb.mongodb.net:27017,ac-idndlum-shard-00-01.2kh2yzb.mongodb.net:27017,ac-idndlum-shard-00-02.2kh2yzb.mongodb.net:27017/?ssl=true&replicaSet=atlas-vvu0cf-shard-0&authSource=admin&retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001593759963'))
