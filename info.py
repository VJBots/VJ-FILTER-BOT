...
API_ID = int(environ.get('API_ID', '29884285'))
API_HASH = environ.get('API_HASH', '6f3d8616638271ea1de3c28f20b4f45a')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5647415588').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001982899407').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Tro:TROFILES@file.51uzgbl.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '1f840696d33beb166e15fe718e7d1dd3c20da3b9')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001621484376'))
