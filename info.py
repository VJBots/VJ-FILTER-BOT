...
API_ID = int(environ.get('API_ID', '23775436'))
API_HASH = environ.get('API_HASH', 'e1d373b4fdf87794e8d8eaeb7ae43e0a')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5931464158').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001646300493').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shettymovies:R18njJlkVOoGaJXitrs@cluster0.tqrsexj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "shettymovies")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002076269656'))
