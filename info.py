...
URL = "https://demobots-u694.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demobots-u694.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = " https://demobots-u694.onrender.com/".format(FQDN)
else:
    URL = "https://demobots-u694.onrender.com/".format(FQDN)
