...
API_ID = int(environ.get('API_ID', '22709194'))
API_HASH = environ.get('API_HASH', '4f219f24230466bcace4fc40fa292da5')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6215950677').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002071655800').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "myywls5")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002048994320'))
