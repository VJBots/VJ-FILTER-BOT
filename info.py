...
API_ID = int(environ.get('API_ID', '29542624'))
API_HASH = environ.get('API_HASH', '3c56d302959f4b96d1fe430916888bfe')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1605938926').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1851874191').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sdscocking666:Max9yCrijVfm8Uko@cluster0.r4qevpk.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1696522890'))
