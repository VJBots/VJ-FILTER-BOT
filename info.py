...
URL = "https://alas-now-made-by-abhishek.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://alas-now-made-by-abhishek.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://alas-now-made-by-abhishek.onrender.com".format(FQDN)
else:
    URL = "https://alas-now-made-by-abhishek.onrender.com".format(FQDN)
