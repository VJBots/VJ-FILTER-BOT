...
URL = "https://rename-dpgu.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://rename-dpgu.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://rename-dpgu.onrender.com/".format(FQDN)
else:
    URL = "https://rename-dpgu.onrender.com/".format(FQDN)
