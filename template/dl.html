...
<head>
    <meta charset="UTF-8">
    <link rel="shortcut icon" href="https://ibb.co/D5zqNj3/Logo-Teamrioupdates.png" type="image/x-icon">
    <meta property="og:image" content="https://ibb.co/D5zqNj3/Logo-Teamrioupdates.png" itemprop="thumbnailUrl">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>%s | Teamrioupdates</title>
...
<body class='bg-gradient-to-bl from-yellow-500 via-red-600 to-orange-500'>
    <header>
        <!-- Navbar -->
            <nav class="navbar bg-dark p-lg-4 p-2">
               <div class="d-flex ">
                ...
                <div class="offcanvas-header d-block">
                    ...
                    <div class="d-flex ">
                        <!-- logo -->
                        <img src="https://ibb.co/D5zqNj3/Logo-Teamrioupdates.png" width="80" height="80" class="rounded" style="box-shadow: 3px 5px 11px black;" alt="">
                        <div class="p-3">
                            <h4 class="offcanvas-title font-semibold wow animate__animated animate__fadeInLeft " id="offcanvasWithBothOptionsLabel" style="text-shadow: 3px 5px 11px black;" >LazyDeveloperr</h4>
                    ...
                    <a href="https://github.com/TEAM-RIO-NETWORKS" target="_blank" class="btn btn-dark w-100 text-light fw-semibold flex justify-center items-center gap-2 mt-2 wow animate__animated animate__fadeInDown  ">
                    ...
                    <div class="d-flex gap-1 px-1 mt-1 wow animate__animated animate__fadeInLeft animate__delay-1s ">
                        <a href="https://teleram.me/creatorrio" target="_blank" class="btn btn-secondary w-50 text-light fw-semibold flex justify-center items-center gap-2 text-xs">
                        ...
                        <a href="https://github.com/TEAM-RIO-NETWORKS/THALAPATHY-FILTER-BOT" target="_blank" class="btn btn-primary w-50 text-light  fw-semibold flex justify-center items-center gap-2 text-xs">
                        ...
                        <a href="https://youtube.com/" target="_blank" class="btn btn-danger w-50 text-light fw-semibold flex justify-center items-center gap-2 text-xs">
                ...
                <div class="offcanvas-body">
                    ...
                    <div class=" d-block px-5 wow animate__animated animate__fadeInRight ">
                        <a href="https://t.me/tamilmovies4Krio" type="button" class="btn btn-outline-secondary w-100 mt-1 wow animate__animated animate__fadeIn ">Trending Movies</a>
                        <a href="https://t.me/tamilmovies4Krio" type="button" class="btn btn-outline-secondary w-100 mt-1">Newly Released Movies</a>
                        <a href="https://t.me/tamilmovies4Krio" type="button" class="btn btn-outline-secondary w-100 mt-1">Popular on Movies Available</a>
                        <a href="https://t.me/tamilmovies4Krio" type="button" class="btn btn-outline-secondary w-100 mt-1">Bollywood Movies</a>
                        <a href="https://t.me/tamilmovies4Krio" type="button" class="btn btn-outline-secondary w-100 mt-1">Hollwood Movies</a>
                        <a href="https://t.me/tamilmovies4Krio" type="button" class="btn btn-outline-secondary w-100 mt-1">webseries</a>
                    </div>
                ...
                <div class="m-2 mt-4">
                    ...
                    <div class="text-center w-100">
                        ...
                        <div class="text-center w-100 px-2 flex justify-center items-center gap-2">
                            ...
                            <span class="font-bold bg-clip-text text-[18px] text-transparent bg-gradient-to-r from-yellow-400  via-orange-700 to-red-700" style="text-shadow: 3px 5px 11px black;">Teamrioupdates</span>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <a class="navbar-brand  text-light fw-bold " href="https://t.me/tamilmovies4Krio">
    ...
    <div class="container flex justify-center items-center min-h-screen ">
        <a class="w-full flex justify-center items-center " href=%s>
            <div class="col-lg-4 p-2 col-12 rounded-3xl bg-dark text-white text-center align-items-center hover:bg-gradient-to-r from-pink-500 to-violet-500 hover:shadow-md hover:shadow-gray-100 hover:translate-y-[-5px] transition transition-all duration-300 wow animate__animated animate__rubberBand">
                Download
                <span aria-hidden>_</span>
                <span aria-hidden class="">_404 Error</span>
                <span aria-hidden class="">_%s</span>
            </div>
        </a>
    </div>
    ...
    <footer class="bg-dark justify-content-around align-items-center">
        <div class="container-fluid  justify-content-center align-itemsd x. -center">
            ...
            <section class="lg:p-4 p-2 justify-content-center align-items-center text-center ">  
                <!-- ADMIN -->
                <a class="btn btn-outline-light btn-floating m-1 rounded-circle p-2 border-secondary wow animate__animated animate__fadeInLeft hover:shadow-md hover:shadow-gray-400 hover:translate-y-[-5px] transition transition-all duration-200" href="https://t.me/creatorrio" target="_blank" role="button">
                ...
                <!-- OWNER -->
                <a class="btn btn-outline-light btn-floating m-1 rounded-circle p-2 border-secondary wow animate__animated animate__fadeInDown animate__delay-1s hover:shadow-md hover:shadow-gray-400 hover:translate-y-[-5px] transition transition-all duration-300" href="https://t.me/creatorrio" target="_blank" role="button">
                ...
                <!-- Github -->
                <a class="btn btn-outline-light btn-floating m-1 rounded-circle p-2 border-secondary wow animate__animated animate__fadeInUp animate__delay-2s hover:shadow-md hover:shadow-gray-400 hover:translate-y-[-5px] transition transition-all duration-300" href="https://github.com/TEAM-RIO-NETWORKS" target="_blank" role="button">
                 <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30">
              ...
              <!-- For creatorrio // credit --- Please don't remove footer credit -->
              <div class="row flex-row-reverse text-secondary justify-content-center align-items-center">
                  <div class="col-lg-6 col-12 justify-content-center align-items-center text-center p-1 wow animate__animated animate__fadeInRight">
                    <ul class="navbar-nav">
                        <li class="navbar-item bg-gradient-to-r from-pink-500 rounded-xl p-2"> <h5 class="text-gray-100 font-semibold text-sm"> Think & just code it... </h5><sup class="badge badge-error text-xs text-gray-300 font-monospace">-creatorrio</sup> </li>
                    </ul>
                </div>
                <div class="col-lg-6 col-12 justify-content-center align-items-center text-center p-1 wow animate__animated animate__fadeInLeft">
                    <ul class="navbar-nav">
                        <li class="navbar-item bg-gradient-to-l from-pink-500 rounded-xl p-2 "> <h5 class="text-gray-100 font-semibold text-sm" > Success is the journey of millions of failure and lots of hard work </h5> <sup class="badge  text-xs text-gray-300 font-monospace">-creatorrio</sup> </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-4 justify-content-center align-items-center text-center mt-lg-0 mt-5  pt-lg-0 pt-4 wow animate__animated animate__fadeInUp">
                    <ul class="navbar-nav ">
                        <li class="nav-item justify-center items-center flex"  style="margin-top: -40px;">
                            <img src="https://ibb.co/D5zqNj3/Logo-Teamrioupdates.png" height="140px" class="rounded-3 " alt="logo">
                        </li>
                        <!-- <li class="nav-item justify-center items-center text-center">
                            <a  class="nav-link h1 text-center sm:-m-1 -ms-4"><h5><a class="font-bold" href="https://t.me/tamilmovies4Krio" target="_blank">Movies : </a>Run and managed by <a href="https://telegram.me/creatorrio" target="_blank" class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-orange-500 to-pink-500">Adil</a> & <a href="https://telegram.me/creatorrio" target="_blank">Indu(<a href="https://telegram.me/creatorrio" target="_blank" class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-orange-500 to-pink-500">Teamrioupdates</a>)</a> </h5></a>
                        </li> -->
                    </ul>
                </div>
            ...
            <div class=" justify-center items-center text-center w-full text-center flex ">
                <div  class="text-gray-400 text-center sm:-m-1 -ms-4 m-2 p-2">
                    <h5>
                        <a class="font-bold" href="https://t.me/tamilmovies4Krio" target="_blank">Movies : </a>Run and managed by <a href="https://telegram.me/Aadil_h" target="_blank" class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-orange-500 to-pink-500">Adil</a> & <a href="https://telegram.me/creatorrio" target="_blank">Indu(<a href="https://telegram.me/creatorrio" target="_blank" class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-orange-500 to-pink-500">Teamrioupdates</a>)
                        </a> 
                    </h5>
                </div>
            </div>
        ...
        <div class="text-center text-xs p-3 dark:text-light text-light gap-2" style="background-color: rgba(0, 0, 0, 0.2);">
            <!-- For LazyDeveloper & creatorrio // credit --- Please don't remove footer credit -->
        ©  <script type="text/JavaScript">
            var theDate=new Date() 
                document.write(theDate.getFullYear()) 
        </script> Copyright :
            <a class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-pink-500 to-violet-500 font-bold tracking-wide px-1" href="https://telegram.me/LazyDeveloperr">LazyDeveloperr</a>
            <!--🥰  Thank you for giving me credit @LazyDeveloperr & @creatorrio  🥰 -->
            All right reserved
        </div>   
    </footer>
